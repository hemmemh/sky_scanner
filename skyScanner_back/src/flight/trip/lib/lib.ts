...
export const getMinMaxTime = (trips:Trip[][])=>{
  let minTime = +trips[0][trips[0].length - 1].arrival_time -  +trips[0][0].departure_time
  let maxTime = +trips[0][trips[0].length - 1].arrival_time -  +trips[0][0].departure_time
...
export const getMinMaxTimeWithReturn = (trips:[Trip[], Trip[]][])=>{
  let minTime = +trips[0][0][trips[0][0].length - 1].arrival_time -  +trips[0][0][0].departure_time
  let maxTime = +trips[0][0][trips[0][0].length - 1].arrival_time -  +trips[0][0][0].departure_time
