...
import {
  ...
  getProfile,
  logout,
} from "@/components/shared/api/user/user";
...
export const addLovesAction = createAsyncThunk(
  "user/addLoves",
  async (loves: Partial<ILoves>) => {
    try {
...
export const deleteLovesAction = createAsyncThunk(
  "user/deleteLoves",
  async (id: string) => {
    try {
