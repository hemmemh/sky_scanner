...
import { Button, FormControl, IconButton, MenuItem, Modal, Select, SelectChangeEvent } from '@mui/material';
...
export const LanguageChange:FC<ILanguageChange> = memo(({ onChange, value }) => {
