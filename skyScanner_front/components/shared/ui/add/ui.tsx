...
export const Add = memo(() => {
  ...
  return (
    <div className={styles.item}>
      ...
      <Title color="#000" className={styles.titleColor} size="medium">
        {t("advertise.title")}
      </Title>
      <Title color="#000" className={styles.titleColor} size="text">
        {t("advertise.underTitle")}
      </Title>
      <Button sx={{ width: "100%" }} variant="contained">
        {t("advertise.exploreHotel")}
      </Button>
    </div>
  );
});
