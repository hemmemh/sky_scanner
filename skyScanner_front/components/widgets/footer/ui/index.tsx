            ...
            <div className={styles.action_colums}>
              <div className={styles.action_column}>
                <Link className={styles.action} href={""}>
                  <div>{t("footer.part1")}</div>
                </Link>
                <Link className={styles.action} href={""}>
                  <div>{t("footer.part2")}</div>
                </Link>
                <Link className={styles.action} href={""}>
                  <div>{t("footer.part3")}</div>
                </Link>
              </div>
              <div className={styles.action_column}>
                <Link href={""}>
                  <div className={styles.action}>{t("footer.part4")}</div>
                </Link>
                <Link href={""}>
                  <div className={styles.action}>{t("footer.part5")}</div>
                </Link>
                <Link href={""}>
                  <div className={styles.action}>{t("footer.part6")}</div>
                </Link>
              </div>

              <div className={styles.action_column}>
                {Object.keys(footerLng.ru)
                  .slice(7, 11)
                  .map((el, i) => (
                    <Accordion sx={accordionStyle} key={el}>
                      <AccordionSummary
                        ...
                        id="panel1-header"
                      >
                        <Title size="small" className={styles.titleAccordion}>
                          {" "}
                          {t(`footer.${el}`)}
                        </Title>
                      </AccordionSummary>
